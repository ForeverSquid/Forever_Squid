...
<!-- CSS -->
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/reset_login.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/supersized_login.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/style_login.css">
...
<body oncontextmenu="return false">
	...
	<div class="page-container">
		<h1>登录</h1>
		<form action="<%=request.getContextPath()%>/method/param/login.jhtml"
			method="post">
			<div>
	...
	<script
		src="<%=request.getContextPath()%>/js/supersized.3.2.7.min_login.js"></script>
