...
<link href="<%=path %>/Images_m/web.css?v20150217" rel="stylesheet" />
<link rel="stylesheet" href="<%=path %>/css_m/stylesheets/style.css">
<script src="<%=path %>/js_m/jquery-1.7.2.min.js"></script>
...
<%@ include file="pages/top.jsp" %>	
  ...
  <div id="douban" style="margin:auto">
    ...
    <script src="<%=path %>/src_m/js/smusic.min.js"></script> 
    <script>
...
var musicList = [
...

	{
		...
		src    : 'http://m1.music.126.net/LbMLZkrwsLjdJTma_5t07g==/6664139976831960.mp3'
...

	{
		...
		src    : 'http://m1.music.126.net/c20PhzGfxxbFWt1F8OgMMA==/1273234464965188.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/MCAbtTCQPPivZWFkVu7-4g==/3083030604295585.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/em-9QLmiSaCDpNzZg_FsTQ==/5750445813388288.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/ucwxV9e1dz17kcsGLa_MHw==/5989039836531478.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/Ph6TZVGaHkOaDtHOucx6Sg==/6018726650832640.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/MyWaykZ-XILx4zAk7rTEaw==/1907652674191597.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/bf1BeqBvMtvdQc8plIn7Tw==/3235862723062694.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/E4oQ14HgWdfDuBr407TL0Q==/5797724813344402.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/qQCuHRFd-IDye9iJD5VJWA==/5993437883324489.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/mmI0IqladI65DqTdKT24ag==/2128654511387653.mp3'
...

{
		...
		src    : 'http://m1.music.126.net/JQh4rsr0oYMKSAeVyXOZXQ==/5963751069502365.mp3'
...

{
...

	{
		...
		src    : 'http://m1.music.126.net/hQ4IYOSm8_npKsYS03k7lg==/6626756580806029.mp3'
...
,
...

	{
		...
		src    : 'http://m1.music.126.net/7gPDR0D6x9QyFgDMkykOsg==/5718559976120783.mp3'
...
new SMusic({
    ...
    <link rel="stylesheet" href="<%=path %>/src_m/css/smusic.css"/>
  </div>
  <div style=" position:relative; top:-230px; margin:auto;width:500px; height:40px"> <a style="text-align:center"  href="<%= request.getContextPath()%>/method/param/weibo.jhtml" class="btn hint  hint-top" data-hint="想细细了解一番？去微博。"><span>_</span> 去她(他)的微博</a> &nbsp;  &nbsp;  &nbsp; <a style="text-align:center" href="<%= request.getContextPath()%>"   class="btn hint  hint-top" data-hint="首页还在建设中呢，就留在这里听听歌吧QAQ。"><span>_</span>返回首页</a>
    <link rel="stylesheet" href="<%=path %>/css_m/style.css" media="screen" type="text/css" />
  
</form>

</body>
</html>
<script type="text/javascript" src="<%=path %>/Images_m/jquery.js"></script>
<script type="text/javascript" src="<%=path %>/Images_m/ThreeWebGL.js"></script>
<script type="text/javascript" src="<%=path %>/Images_m/ThreeExtras.js"></script>
<script type="text/javascript" src="<%=path %>/Images_m/Detector.js"></script>
<script type="text/javascript" src="<%=path %>/Images_m/RequestAnimationFrame.js"></script>
...
<script type="text/javascript" src="<%=path %>/Images_m/cloud.js"></script>
